...
<head>
<meta charset="UTF-8">
<title>My Cart | GalaXy 8uy</title>
<style>
:root {
	--primary: #2563eb;
...
.cart-header {
	...
	/* Aligns the bottom of the button with the bottom of the "My Cart" text */
	width: 100%;
...
<div id="loader">
	...
	<div class="cart-wrapper">
		<div class="cart-header">
			...
			<a href="HomeServlet" class="back-btn"> Return to Products </a>
		</div>
		...
		<div class="cart-layout">
			...
			<div class="cartContainer">
				...
				%>
				<div class="cartCard" id="cartCard<%=cart.getProduct().getId() %>">

					<div class="product-details">
						<h2>
							<a href="ProductServlet?id=<%=cart.getProduct().getId()%>"> <%=cart.getProduct().getName()%>
							</a>
						</h2>
						<div class="price-info">
							<p>
								<b>Price:</b> Rs
								<%=cart.getProduct().getPrice()%></p>
							<p>
								<b>Subtotal:</b> Rs <span
									id="subtotal<%=cart.getProduct().getId()%>"> <%=cart.getQuantity() * cart.getProduct().getPrice()%>
								</span>
							</p>
					...
					<div class="cart-actions">
						...
						<div class="quantitySelector">
							...
							<button class="qtyBtn" type="button"
								onclick="updateCart(<%=cart.getProduct().getId()%>,'decrease')">

								-</button>

							<span id="qty<%=cart.getProduct().getId()%>"> <%=cart.getQuantity()%>

							</span>

							<button class="qtyBtn" type="button"
								onclick="updateCart(<%=cart.getProduct().getId()%>,'increase')">
						...
						<button class="removeButton" type="button"
							onclick="updateCart(<%=cart.getProduct().getId()%>,'remove')">
			...
			<div class="cartSummary">
				...
				<h2>
					<span>Total:</span> <span class="grand-total-amount"
						id="grandTotal">Rs <%=total%></span>
				</h2>
				<form action="CheckoutServlet" method="post" onsubmit="showLoader()">
	...
	function updateCart(productId, action){
	    ...
	    .then(data => {
	        ...
	        // Only update if a cart badge exists
